...
<html>
    ...
    <body>
        ...
        <%-- 선언문(declaration) --%>
        <%! // %로 시작하는 태그 안쪽은 자바에서 사용하는 주석을 사용하면 됨. //, /* */
        ...
        1. Servlet: Server + Applet 합성어.
           ...
           - 서블릿 객체의 생성과 서블릿 객체의 메서드 호출은 WAS가 담당.
            * 최초 요청: 서블릿 객체 생성 -> doGet, doPost메서드 호출 -> 응답.
            * 요청(두번째부터): 생성되어 있는 서블릿 객체의 doGet, doPost 메서드 호출 -> 응답.
