...
// 자바스크립트 함수는 파라미터의 타입을 검사하지 않음. 그래서 오류가 생기면 함수를 호출하는 쪽을 한번더 확인 해야함.
...
/*
 JavaScript 합수의 특징: 함수는 객체(object)이다.
...
result = plus(100, 200); // 변수 puls는 함수.
console.log('result =', result);
...
// 화살표 함수(arrow function) 람다표현식과 비슷
// (파라미터, ...) => {} 실행코드; ...}
// (파라미터, ...) => 리턴값
