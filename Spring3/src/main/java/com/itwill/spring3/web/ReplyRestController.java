...
public class ReplyRestController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> update(@PathVariable long id, @RequestBody ReplyUpdateDto dto) { // 위에 파라미터 값/{id}과 여기의 아규먼트값(long id)을 맞춰주어야함. 하지만 클라이언트와는 맞출 필요가 없음.
