...
public class DbcpTest {
    // Log4j2 기능을 구현한 Slt4j 라이브러리의 로깅 기능 사용해서 로그 출력:
    ...
    public void testHikariCP() throws SQLException {
        ...
        // HikariCP 환경 설정:
        config.setDriverClassName("oracle.jdbc.OracleDriver"); // JDBC 드라이버(라이브러리)
        ...
        // 환경 설청을 갖는 Connection Pool(Data Source) 객체 생성
        ...
        conn.close(); // 데이터 베이스 서버와의 접속을 물리적으로 끊는 게 아님.
        log.info("conn 반환 성공.");
